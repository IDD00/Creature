...
namespace Creature.Builder
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.creaturesBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            this.playerTeamBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.creaturesBindingSource)).BeginInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.playerTeamBindingSource)).BeginInit();
            ...
            this.mainFormMenuStrip.Size = new System.Drawing.Size(882, 28);
            ...
            this.healthNumericUpDown.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.creaturesBindingSource, "MaxHealth", true));
            ...
            // 
            this.creaturesBindingSource.DataMember = "Creatures";
            this.creaturesBindingSource.DataSource = this.gameViewModelBindingSource;
            // 
            // gameViewModelBindingSource
            // 
            this.gameViewModelBindingSource.DataSource = typeof(Creature.Builder.ViewModels.GameViewModel);
            // 
            // creatureResistanceComboBox
            // 
            this.creatureResistanceComboBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.creaturesBindingSource, "Resistance", true));
            ...
            this.skillRecoverNumericUpDown5.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.skillsBindingSource, "Heal", true));
            this.skillRecoverNumericUpDown5.Location = new System.Drawing.Point(293, 210);
            this.skillRecoverNumericUpDown5.Maximum = new decimal(new int[] {
            9999,
            0,
            0,
            0});
            ...
            // skillsBindingSource
            // 
            this.skillsBindingSource.DataMember = "SkillSet";
            this.skillsBindingSource.DataSource = this.creaturesBindingSource;
            // 
            // skillArmorNumericUpDown
            // 
            this.skillArmorNumericUpDown.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.skillArmorNumericUpDown.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.skillsBindingSource, "Shield", true));
            this.skillArmorNumericUpDown.Location = new System.Drawing.Point(293, 155);
            this.skillArmorNumericUpDown.Maximum = new decimal(new int[] {
            9999,
            0,
            0,
            0});
            ...
            this.skillChargeNumericUpDown.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.skillsBindingSource, "Boost", true));
            this.skillChargeNumericUpDown.Location = new System.Drawing.Point(293, 100);
            this.skillChargeNumericUpDown.Maximum = new decimal(new int[] {
            9999,
            0,
            0,
            0});
            ...
            this.skillPowerNumericUpDown.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.skillsBindingSource, "Power", true));
            this.skillPowerNumericUpDown.Location = new System.Drawing.Point(293, 45);
            this.skillPowerNumericUpDown.Maximum = new decimal(new int[] {
            9999,
            0,
            0,
            0});
            ...
            // 
            this.skillElementComboBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.skillsBindingSource, "Element", true));
            ...
            this.skillDescriptionTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.skillsBindingSource, "Description", true));
            ...
            this.skillNameTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.skillsBindingSource, "Name", true));
            ...
            // 
            this.creatureWeaknessComboBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.creaturesBindingSource, "Weakness", true));
            ...
            this.creatureSkillsListBox.DataSource = this.skillsBindingSource;
            this.creatureSkillsListBox.DisplayMember = "Name";
            ...
            this.textBox2.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.creaturesBindingSource, "Description", true));
            ...
            this.nameTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.creaturesBindingSource, "Name", true));
            ...
            this.deleteCreatureButton.Click += new System.EventHandler(this.DeleteCreatureButton_Click);
            // 
            // newCreatureButton
            // 
            ...
            this.creatureIndexListBox.DataSource = this.creaturesBindingSource;
            this.creatureIndexListBox.DisplayMember = "Name";
            ...
            this.creaturesListBox.DataSource = this.creaturesBindingSource;
            this.creaturesListBox.DisplayMember = "Name";
            ...
            this.playerTeamListBox.DataSource = this.playerTeamBindingSource;
            this.playerTeamListBox.DisplayMember = "Name";
            ...
            // 
            // playerTeamBindingSource
            // 
            this.playerTeamBindingSource.DataMember = "PlayerTeam";
            this.playerTeamBindingSource.DataSource = this.gameViewModelBindingSource;
            // 
            // messagesGroupBox
            // 
            ...
            this.startMessageTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.gameViewModelBindingSource, "Game.StartMessage", true));
            ...
            ((System.ComponentModel.ISupportInitialize)(this.creaturesBindingSource)).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.playerTeamBindingSource)).EndInit();
